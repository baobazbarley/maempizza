...
<head>
    ...
    <![endif]-->
    <meta name="description" content="Layanan pesan antar pizza homemade terbaik di Yogyakarta, Indonesia.
        Pilih atau buat pizza sesuai seleramu">
    <meta name="keywords" content="pizza, pizza delivery, pizza jogja, pizza homemade, order pizza,
        pizza online, maem pizza, pesan antar pizza, pizza terbaik, lukis pizza">
    <meta name="author" content="Bubu Caca">
	...
	<title>Beranda - Maem Pizza</title>
...
<body>
    ...
    <header class="page-header page-header-normal">
        ...
        @include('shared.page-top')

        @include('shared.main-navigation')
