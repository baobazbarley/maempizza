...
<footer class="page-footer">
    <div class="container">
        <div class="row">
            <div class="col-md-4 responsive-column">
                <h2 class="footer-heading">Jam Buka</h2>
            ...
            <div class="col-md-4 text-center responsive-column">
                ...
                <p class="logo-footer-text">MAEMPIZZA</p>
                <p class="logo-footer-detail">Makan... ya MaemPizza</p>
    ...
    <div class="site-info">
        <div class="container">
            <div class="row">
                <div class="col-xs-8">
                    2015 All rights reserved. By MaemPizza
                </div>
